 ...
 * @author Logan Roe
 */
public class Pacman extends Abstract
{
  ...
  /**
   * Overrides the reset function in Abstract as it is slightly different.
   * This will reset all of the values of Pac-Man back to base level.
   */
  @Override
  public void reset()
  {
  ...
  /**
   * This will update Pac-Man's position based upon numerous factors such as if he is turning, what direction he is facing, and so on.
   * @param d
   */
  @Override
